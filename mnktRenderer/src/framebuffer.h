...
*/
void mnkt_framebufferClearColor(const unsigned char r, const unsigned char g, const unsigned char b, Framebuffer_t* framebuffer);
...
*/
void mnkt_framebufferClearDepth(float depth, Framebuffer_t* framebuffer);
